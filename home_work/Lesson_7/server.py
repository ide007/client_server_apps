...
def main():
    ...
    while True:
        ...
        try:
            ...
            server_logger.info(f'Отправляем сообщение {response} клиенту'
                               f' {client_address}')
            client_socket.close()
            server_logger.debug(f'Соединение с клиентом {client_address} '
                                f'закрыто.')
            ...
            server_logger.info(f'Соединение с клиентом {client_address} '
                               f'закрыто.')
            client_socket.close()
